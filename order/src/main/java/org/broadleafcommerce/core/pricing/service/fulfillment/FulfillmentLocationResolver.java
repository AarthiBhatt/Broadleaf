...
public interface FulfillmentLocationResolver {
    ...
    /**
     * This method should give an {@link OrderAddress} that a particular {@link FulfillmentGroup} will
     ...
     * 
     * @param group
     * @return the {@link OrderAddress} that <b>group</b> should be fulfilled from
     */
